...
beta = 0.000511 / (e.structure_norm ** 2)  # Electron mass in GeV
...
m_p = beta * A_p**2 * 1000  # Convert GeV to MeV
...
print(f"  Delta_A_sq_EM = {proton.em_energy:.4e}")
print()
...
m_n = beta * A_n**2 * 1000  # Convert GeV to MeV
...
print(f"  Delta_A_sq_EM = {neutron.em_energy:.4e}")
print()
...
print(f"{'Delta_A_sq_EM:':20s} {proton.em_energy:>15.4e} {neutron.em_energy:>15.4e} {neutron.em_energy-proton.em_energy:>+15.4e}")
print()
